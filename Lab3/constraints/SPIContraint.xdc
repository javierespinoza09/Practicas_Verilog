...
set_property PACKAGE_PIN E3 [get_ports clkfast]							
	set_property IOSTANDARD LVCMOS33 [get_ports clkfast]
	create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports clkfast]
 
## Switches
##Bank = 34, Pin name = IO_L21P_T3_DQS_34,					Sch name = SW0
set_property PACKAGE_PIN U9 [get_ports {DatosIN[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {DatosIN[0]}]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports {DatosIN[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {DatosIN[1]}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {DatosIN[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {DatosIN[2]}]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
set_property PACKAGE_PIN R6 [get_ports {DatosIN[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {DatosIN[3]}]
##Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
set_property PACKAGE_PIN R5 [get_ports {DatosIN[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {DatosIN[4]}]
##Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
set_property PACKAGE_PIN V7 [get_ports {DatosIN[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {DatosIN[5]}]
##Bank = 34, Pin name = IO_L20N_T3_34,						Sch name = SW6
set_property PACKAGE_PIN V6 [get_ports {DatosIN[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {DatosIN[6]}]
##Bank = 34, Pin name = IO_L10P_T1_34,						Sch name = SW7
set_property PACKAGE_PIN V5 [get_ports {DatosIN[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {DatosIN[7]}]
##Bank = 34, Pin name = IO_L8P_T1-34,						Sch name = SW8
set_property PACKAGE_PIN U4 [get_ports {EN}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {EN}]
##Bank = 34, Pin name = IO_L9N_T1_DQS_34,					Sch name = SW9
set_property PACKAGE_PIN V2 [get_ports {start}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {start}]
##Bank = 34, Pin name = IO_L9P_T1_DQS_34,					Sch name = SW10
set_property PACKAGE_PIN U2 [get_ports {clear}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {clear}]
##Bank = 34, Pin name = IO_L11N_T1_MRCC_34,					Sch name = SW11
set_property PACKAGE_PIN T3 [get_ports {VerCuenta}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {VerCuenta}]
...
set_property PACKAGE_PIN T8 [get_ports {ready}]					
...
set_property PACKAGE_PIN L3 [get_ports {Cathode_Control[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Cathode_Control[0]}]
##Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
set_property PACKAGE_PIN N1 [get_ports {Cathode_Control[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Cathode_Control[1]}]
##Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
set_property PACKAGE_PIN L5 [get_ports {Cathode_Control[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Cathode_Control[2]}]
##Bank = 34, Pin name = IO_L5N_T0_34,						Sch name = CD
set_property PACKAGE_PIN L4 [get_ports {Cathode_Control[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Cathode_Control[3]}]
##Bank = 34, Pin name = IO_L2P_T0_34,						Sch name = CE
set_property PACKAGE_PIN K3 [get_ports {Cathode_Control[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Cathode_Control[4]}]
##Bank = 34, Pin name = IO_L4N_T0_34,						Sch name = CF
set_property PACKAGE_PIN M2 [get_ports {Cathode_Control[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Cathode_Control[5]}]
##Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
set_property PACKAGE_PIN L6 [get_ports {Cathode_Control[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Cathode_Control[6]}]
...
set_property PACKAGE_PIN N6 [get_ports {Anode_Control[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Anode_Control[0]}]
##Bank = 34, Pin name = IO_L18P_T2_34,						Sch name = AN1
set_property PACKAGE_PIN M6 [get_ports {Anode_Control[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Anode_Control[1]}]
##Bank = 34, Pin name = IO_L4P_T0_34,						Sch name = AN2
set_property PACKAGE_PIN M3 [get_ports {Anode_Control[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Anode_Control[2]}]
##Bank = 34, Pin name = IO_L13_T2_MRCC_34,					Sch name = AN3
set_property PACKAGE_PIN N5 [get_ports {Anode_Control[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Anode_Control[3]}]
##Bank = 34, Pin name = IO_L3P_T0_DQS_34,					Sch name = AN4
set_property PACKAGE_PIN N2 [get_ports {Anode_Control[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Anode_Control[4]}]
##Bank = 34, Pin name = IO_L16N_T2_34,						Sch name = AN5
set_property PACKAGE_PIN N4 [get_ports {Anode_Control[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Anode_Control[5]}]
##Bank = 34, Pin name = IO_L1P_T0_34,						Sch name = AN6
set_property PACKAGE_PIN L1 [get_ports {Anode_Control[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Anode_Control[6]}]
##Bank = 34, Pin name = IO_L1N_T034,							Sch name = AN7
set_property PACKAGE_PIN M1 [get_ports {Anode_Control[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Anode_Control[7]}]
...
set_property PACKAGE_PIN B13 [get_ports {SS}]					
