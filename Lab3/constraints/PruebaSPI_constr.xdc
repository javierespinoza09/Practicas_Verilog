...
set_property PACKAGE_PIN U9 [get_ports {datoIN[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {datoIN[0]}]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports {datoIN[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {datoIN[1]}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {datoIN[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {datoIN[2]}]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
set_property PACKAGE_PIN R6 [get_ports {datoIN[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {datoIN[3]}]
##Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
set_property PACKAGE_PIN R5 [get_ports {datoIN[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {datoIN[4]}]
##Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
set_property PACKAGE_PIN V7 [get_ports {datoIN[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {datoIN[5]}]
##Bank = 34, Pin name = IO_L20N_T3_34,						Sch name = SW6
set_property PACKAGE_PIN V6 [get_ports {datoIN[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {datoIN[6]}]
##Bank = 34, Pin name = IO_L10P_T1_34,						Sch name = SW7
set_property PACKAGE_PIN V5 [get_ports {datoIN[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {datoIN[7]}]
...
set_property PACKAGE_PIN T8 [get_ports {datoOUT[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {datoOUT[0]}]
##Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
set_property PACKAGE_PIN V9 [get_ports {datoOUT[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {datoOUT[1]}]
##Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
set_property PACKAGE_PIN R8 [get_ports {datoOUT[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {datoOUT[2]}]
##Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
set_property PACKAGE_PIN T6 [get_ports {datoOUT[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {datoOUT[3]}]
##Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = LED4
set_property PACKAGE_PIN T5 [get_ports {datoOUT[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {datoOUT[4]}]
##Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
set_property PACKAGE_PIN T4 [get_ports {datoOUT[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {datoOUT[5]}]
##Bank = 34, Pin name = IO_L22P_T3_34,						Sch name = LED6
set_property PACKAGE_PIN U7 [get_ports {datoOUT[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {datoOUT[6]}]
##Bank = 34, Pin name = IO_L22N_T3_34,						Sch name = LED7
set_property PACKAGE_PIN U6 [get_ports {datoOUT[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {datoOUT[7]}]
