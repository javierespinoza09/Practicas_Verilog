...
set_property PACKAGE_PIN P3 [get_ports {Data[14]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Data[14]}]
##Bank = 34, Pin name = IO_L14P_T2_SRCC_34,					Sch name = SW15
set_property PACKAGE_PIN P4 [get_ports {Data[15]}]					
...
set_property PACKAGE_PIN F15 [get_ports Load1]						
	set_property IOSTANDARD LVCMOS33 [get_ports Load1]
##Bank = CONFIG, Pin name = IO_L15N_T2_DQS_DOUT_CSO_B_14,	Sch name = BTNL
set_property PACKAGE_PIN T16 [get_ports Load0]						
	set_property IOSTANDARD LVCMOS33 [get_ports Load0]
##Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
set_property PACKAGE_PIN R10 [get_ports speed[1]]						
	set_property IOSTANDARD LVCMOS33 [get_ports speed[1]]
##Bank = 14, Pin name = IO_L21P_T3_DQS_14,					Sch name = BTND
set_property PACKAGE_PIN V10 [get_ports speed[0]]						
